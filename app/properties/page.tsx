...
const translations = {
  pl: {
    ...
    header: {
      ...
      description: "Oferujemy różnorodne powierzchnie komercyjne w doskonałej lokalizacji w Tarnowskich Górach.",
    },
    properties: {
      hall: {
        ...
        features: ["Powierzchnia: 110m²", "Kuchnia wyposażona", "Łazienka", "Biuro", "Dostęp samochodowy", "Parking"],
      ...
      billboard: {
        ...
        features: ["Wymiary: 5m x 3m", "Mobilność", "Dwustronna reklama", "Oświetlenie LED", "Montaż grafik", "Serwis"],
    ...
    cta: {
      ...
      description: "Skontaktuj się z nami, aby omówić szczegóły i warunki wynajmu.",
  ...
  en: {
    ...
    header: {
      ...
      description: "We offer various commercial spaces in an excellent location in Tarnowskie Góry.",
    },
    properties: {
      hall: {
        ...
        features: ["Area: 110m²", "Equipped kitchen", "Bathroom", "Office", "Vehicle access", "Parking"],
        price: "Price negotiable",
        available: "Available",
      },
      office: {
        title: "Office Space 80m²",
        description: "Modern office with excellent finishing standard, ideal for service and administrative companies.",
        features: ["Area: 80m²", "Double toilet", "Air conditioning", "Fiber internet", "Parking", "Reception"],
        price: "Price negotiable",
        available: "Available",
      },
      area: {
        title: "Paved Area 500m²",
        description: "Large paved area by the main road, ideal for parking, product display, or container offices.",
        features: ["Area: 500m²", "Paved surface", "Main road location", "24/7 access", "Fencing", "Lighting"],
        price: "Price negotiable",
        available: "Available",
      },
      billboard: {
                ...
                <Card key={property.id} className="overflow-hidden hover:shadow-xl transition-shadow duration-300">
                  <div className="aspect-video relative">
                    ...
                    <div className="absolute top-4 right-4">
                      <Badge className="bg-green-100 text-green-800 border-green-200">{property.available}</Badge>
                    </div>
                  </div>
                  <CardHeader>
                    <div className="flex items-center space-x-3 mb-2">
                      ...
                      <div>
                        <CardTitle className="text-xl text-slate-900">{property.title}</CardTitle>
                        <p className="text-lg font-semibold text-teal-600">{property.price}</p>
                      </div>
                    </div>
                  </CardHeader>
                  <CardContent>
                    <p className="text-slate-600 mb-6 leading-relaxed">{property.description}</p>
