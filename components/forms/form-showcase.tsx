...
export default function FormShowcase() {
  ...
  const e2e = isE2E();
  const showAnalytics =
    !e2e && process.env.NEXT_PUBLIC_ENABLE_ANALYTICS === "true";
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4">
        <div className="text-center mb-8">
          <div className="flex items-center justify-center space-x-4 mb-4">
            <h1 className="text-3xl font-bold text-gray-900">
              {language === "pl"
                ? "Formularze kontaktowe Gliwicka 111"
                : "Gliwicka 111 Contact Forms"}
            </h1>
          ...
          <div className="flex items-center justify-center space-x-2 mt-4">
            <Badge variant="outline" className="flex items-center space-x-1">
              ...
              <span>
                {language === "pl" ? "RODO Compliant" : "GDPR Compliant"}
              </span>
            </Badge>
            <Badge variant="outline" className="flex items-center space-x-1">
        ...
        <Tabs
          defaultValue="virtual-office"
          className="w-full"
          data-testid="forms-tabs"
        >
          <TabsList className="grid w-full grid-cols-5 mb-8">
            ...
            >
              ...
              <span className="hidden sm:inline">
                {language === "pl" ? "Reklama" : "Advertising"}
              </span>
            </TabsTrigger>
            <TabsTrigger
              value="special-deals"
          ...
          <TabsContent value="meeting-rooms" className="space-y-4">
            <div className="text-center mb-6">
              ...
              <h2 className="text-xl font-semibold mb-2">
                {language === "pl"
                  ? "Profesjonalne sale od 30 zł/godzinę"
                  : "Professional rooms from 30 PLN/hour"}
              </h2>
              <p className="text-gray-600">
                {language === "pl"
          ...
          <TabsContent value="advertising" className="space-y-4">
            <div className="text-center mb-6">
              ...
              <h2 className="text-xl font-semibold mb-2">
                {language === "pl"
                  ? "Mobilny billboard od 350 zł/tydzień"
                  : "Mobile billboard from 350 PLN/week"}
              </h2>
              <p className="text-gray-600">
                {language === "pl"
        ...
        <Card className="mt-12">
          <CardHeader>
            <CardTitle className="text-center flex items-center justify-center space-x-2">
              ...
              <span>
                {language === "pl"
                  ? "Funkcje GDPR/RODO i Analityka"
                  : "GDPR/RODO Features & Analytics"}
              </span>
            </CardTitle>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="text-center p-4">
                ...
                <h4 className="font-medium mb-1">
                  {language === "pl" ? "Wymagana zgoda" : "Required consent"}
                </h4>
              ...
              <div className="text-center p-4">
                ...
                <p className="text-sm text-gray-600">
                  {language === "pl"
                    ? "Anonimizowane śledzenie wydajności"
              ...
              <div className="text-center p-4">
                ...
                <h4 className="font-medium mb-1">
                  {language === "pl" ? "Bezpieczne dane" : "Secure data"}
                </h4>
                <p className="text-sm text-gray-600">
                  {language === "pl"
              ...
              <div className="text-center p-4">
                ...
                <h4 className="font-medium mb-1">
                  {language === "pl" ? "Dwujęzyczne" : "Bilingual"}
                </h4>
                <p className="text-sm text-gray-600">
                  {language === "pl"
