      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Privacy-first form analytics with GDPR compliance
          </p>
        </div>
        ...
        <TabsContent value="forms" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Performance metrics for each form type over the selected time
                period
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-6">
                {Object.entries(mockData.formMetrics).map(
                  ([key, form]: [string, any]) => (
        ...
        <TabsContent value="fields" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Error rates and interaction patterns for form fields
              </CardDescription>
            </CardHeader>
            <CardContent>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Avg focus time: {field.avgFocusTime}
                        </p>
                      </div>
                    </div>
        ...
        <TabsContent value="funnel" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                User journey from form view to completion
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <div className="font-bold">
                        {mockData.overview.totalCompletions}
                      </div>
                      <div className="text-sm text-muted-foreground">
                        {(
                          (mockData.overview.totalCompletions /
          ...
          <TabsContent value="submissions" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Latest form submissions with completion status
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
          ...
          <div className="flex items-start space-x-2">
            ...
            <div>
              ...
              <p className="text-sm text-blue-800 mt-1">
                All data is anonymized and aggregated. No personal information
                is stored or tracked. IP addresses are hashed with salt for
                privacy protection. Data retention: 90 days maximum.
              </p>
            </div>
          </div>
        </CardContent>
